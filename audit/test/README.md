...
* Geth/v1.8.3-stable-329ac18e/darwin-amd64/go1.10 running with the Byzantium fork switched on
...
* The tests were conducted using bash shell scripts running Geth/v1.8.3-stable-329ac18e/darwin-amd64/go1.10 JavaScript commands
